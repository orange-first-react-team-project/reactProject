 ...
 function Contact() {
  ...
  const handleSubmit = async (e) => {
   ...
   return (
     <>
       <Navbar />
       <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2973B2] rounded-lg">
         <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
           <div>
             ...
             <ul class="flex mt-12 space-x-4">
               <li class="bg-[black] hover:bg-[#093356] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
           ...
           <div class="bg-gray-100 p-6 rounded-lg">
             ...
             <div class="space-y-4 max-lg:mt-4"></div>
             ...
             <form class="mt-8 space-y-4" onSubmit={handleSubmit}>
               ...
               <button
                 type="submit"
                 class="text-white bg-[#2973B2] hover:bg-[#093356] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
               >
                 <svg
                   xmlns="http://www.w3.org/2000/svg"
                   width="16px"
