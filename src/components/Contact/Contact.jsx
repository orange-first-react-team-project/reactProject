 ...
 function Contact() {
  ...
  const handleSubmit = async (e) => {
   ...
   return (
     <>
       <Navbar />
       <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2973B2] rounded-lg">
         <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
           ...
           <div className="bg-gray-100 p-6 rounded-lg">
             ...
             <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
               ...
               <button
                 type="submit"
                 className="text-white bg-[#2973B2] hover:bg-[#093356] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
               >
                 <svg
                   xmlns="http://www.w3.org/2000/svg"
                   width="16px"
